...
const appRoutes: Routes = [
	...
	{path: 'temas',   canActivate:[UserGuard], component: TopicsComponent},
	{path: 'temas/:page',   canActivate:[UserGuard], component: TopicsComponent},
	{path: 'tema/:id', component: TopicDetailComponent},
	{path: 'usuarios',   canActivate:[UserGuard], component:UsersComponent},
	{path: 'perfil/:id', component:ProfileComponent},
	{path: 'buscar/:search',  canActivate:[UserGuard], component: SearchComponent},
	{path: '**', component: HomeComponent }
];
